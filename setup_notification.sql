      ...
      <div class="wrapper">
        <div class="card">
          ...
          <div class="header" style="text-align: center;">
            <img src="https://printacote.com/Fichier%207.png" alt="Printacote" width="80" height="80" style="border-radius: 50%; border: 3px solid #F5F5DC; margin-bottom: 15px; background-color: #3D0B37; object-fit: cover; display: inline-block;" />
