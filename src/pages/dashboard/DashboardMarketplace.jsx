                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div key={p.id} className="group bg-white rounded-[3rem] overflow-hidden border border-dark/10 hover:shadow-2xl transition-all duration-500 flex flex-col h-full relative">
                            ...
                            <div className="p-8 flex flex-col flex-1">
                                <div className="flex justify-between items-start gap-4 mb-3">
                                    <h3 className="text-xl font-black text-primary tracking-tight leading-tight group-hover:text-accent transition-colors">{p.name}</h3>
                                ...
                                <div className="text-[10px] font-bold uppercase tracking-widest text-accent mb-3">{p.options?.category || 'Consommable'}</div>
                    ...
                    {products.length === 0 && (
                        <div className="col-span-full bg-accent/5 border-2 border-dashed border-accent/20 rounded-[3.5rem] p-16 text-center">
                            ...
                            <button 
                                onClick={openAddModal}
                                className="bg-accent text-white px-10 py-5 rounded-2xl font-bold flex items-center justify-center gap-3 shadow-2xl shadow-accent/20 mx-auto"
                            >
                    ...
                    <div className="bg-white rounded-[3rem] p-8 md:p-10 w-full max-w-2xl my-8 relative z-10 shadow-2xl animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto custom-scrollbar">
                        ...
                        <form onSubmit={handleAddProduct} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Image du produit</label>
                                <input 
                                    type="file" 
                                    ref={productImageRef} 
                                ...
                                >
                                    {uploadingImage ? (
                                        ...
                                        <>
                                            <ShoppingBag size={32} className="text-dark/30" />
                                            <span className="font-bold text-xs uppercase tracking-widest text-dark/40">Cliquez pour choisir une photo</span>
                                        </>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Nom du produit</label>
                                    <input 
                                        required
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Catégorie</label>
                                    <select 
                            ...
                            {newProduct.category === 'Autre' && (
                                <div className="space-y-2 animate-in fade-in slide-in-from-top-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Préciser la catégorie (Autre)</label>
                                    <input 
                                        required
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Prix (FCFA)</label>
                                    <input 
                                        required
                                        type="number"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Prix Promo (FCFA)</label>
                                    <input 
                                        type="number"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Remise (%)</label>
                                    <input 
                                        type="number"
                                        placeholder="Ex: 15"
                                        className="w-full bg-dark/5 border-2 border-transparent rounded-2xl px-6 py-4 focus:outline-none focus:bg-white focus:border-primary/20 transition-all font-bold text-sm"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Quantité / Stock</label>
                                    <input 
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Format / Volume</label>
                                    <input 
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Qualité / Type</label>
                                    <input 
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-dark/30 ml-2">Description</label>
                                <textarea 
                                    required
                                    rows="4"
